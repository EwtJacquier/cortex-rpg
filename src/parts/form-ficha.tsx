...
const FormFicha = (props: FormProps) => {
  ...
  const difficulty = [
    {value: '1', label: 'Novato, Nível 1'},
    {value: '2', label: 'Experiente, Nível 2'},
    {value: '3', label: 'Veterano, Nível 3'},
    {value: '4', label: 'Especialista, Nível 4'},
    {value: '5', label: 'Lendário, Nível 5'},
  ]
